...
# from schemas import TokenData, UserBase, Token
# from crud_user import get_by_username
...
# Crear un docente
@app.post("/docentes/", response_model=DocenteOut, tags=["docentes"], dependencies=[Depends(get_current_user)])
...
@app.get("/docentes/", response_model=list[DocenteOut], tags=["docentes"], dependencies=[Depends(get_current_user)])
def read_docentes(db: Session = Depends(get_db)):
    docentes = db.query(Docente).all()
    return docentes

# Obtener un docente por ID
@app.get("/docentes/{docente_id}", response_model=DocenteOut, tags=["docentes"], dependencies=[Depends(get_current_user)])
...
@app.put("/docentes/{docente_id}", response_model=DocenteOut, tags=["docentes"], dependencies=[Depends(get_current_user)])
...
# Eliminar un docente
@app.delete("/docentes/{docente_id}", tags=["docentes"], dependencies=[Depends(get_current_user)])
...
# crear asignatura
@app.post("/asignaturas/", response_model=AsignaturaOut, tags=["asignaturas"], dependencies=[Depends(get_current_user)])
...
# listar asignaturas
@app.get("/asignaturas/", response_model=list[AsignaturaOut], tags=["asignaturas"], dependencies=[Depends(get_current_user)])
def read_asignaturas(db: Session = Depends(get_db)):
    asignaturas = db.query(Asignatura).all()
    return asignaturas

# obtener asignatura por ID
@app.get("/asignaturas/{asignatura_id}", response_model=AsignaturaOut, tags=["asignaturas"], dependencies=[Depends(get_current_user)])
...
@app.put("/asignaturas/{asignatura_id}", response_model=AsignaturaOut, tags=["asignaturas"], dependencies=[Depends(get_current_user)])
...
# eliminar asignatura
@app.delete("/asignaturas/{asignatura_id}", tags=["asignaturas"], dependencies=[Depends(get_current_user)])
...
# crear sede
@app.post("/sedes/", response_model=SedeOut, tags=["sedes"], dependencies=[Depends(get_current_user)])
...
@app.get("/sedes/", response_model=list[SedeOut], tags=["sedes"], dependencies=[Depends(get_current_user)])
def read_sedes(db: Session = Depends(get_db)):
    sedes = db.query(Sede).all()
    return sedes
 
# obtener sede por ID
@app.get("/sedes/{sede_id}", response_model=SedeOut, tags=["sedes"], dependencies=[Depends(get_current_user)])
...
# actualizar sede
@app.put("/sedes/{sede_id}", response_model=SedeOut, tags=["sedes"], dependencies=[Depends(get_current_user)])
...
# eliminar sede
@app.delete("/sedes/{sede_id}", tags=["sedes"], dependencies=[Depends(get_current_user)])
...
# crear programa
@app.post("/programas/", response_model=ProgramaOut, tags=["programas"], dependencies=[Depends(get_current_user)])
...
# listar programas
@app.get("/programas/", response_model=list[ProgramaOut], tags=["programas"], dependencies=[Depends(get_current_user)])
def read_programas(db: Session = Depends(get_db)):
    programas = db.query(Programa).all()
    return programas

# obtener programa por ID
@app.get("/programas/{programa_id}", response_model=ProgramaOut, tags=["programas"], dependencies=[Depends(get_current_user)])
...
# actualizar programa
@app.put("/programas/{programa_id}", response_model=ProgramaOut, tags=["programas"], dependencies=[Depends(get_current_user)])
...
# eliminar programa
@app.delete("/programas/{programa_id}", tags=["programas"], dependencies=[Depends(get_current_user)])
...
@app.post("/disponibilidades/", response_model=DisponibilidadOut, tags=["disponibilidades"], dependencies=[Depends(get_current_user)])
...
@app.get("/disponibilidades/", response_model=list[DisponibilidadOut], tags=["disponibilidades"], dependencies=[Depends(get_current_user)])
def read_disponibilidades(db: Session = Depends(get_db)):
    disponibilidades = db.query(Disponibilidad).all()
    return disponibilidades

# obtener disponibilidad por ID
@app.get("/disponibilidades/{disponibilidad_id}", response_model=DisponibilidadOut, tags=["disponibilidades"], dependencies=[Depends(get_current_user)])
...
@app.put("/disponibilidades/{disponibilidad_id}", response_model=DisponibilidadOut, tags=["disponibilidades"], dependencies=[Depends(get_current_user)])
...
@app.delete("/disponibilidades/{disponibilidad_id}", tags=["disponibilidades"], dependencies=[Depends(get_current_user)])
...
# crear periodo 
@app.post("/periodos/", response_model=PeriodoOut, tags=["periodos"], dependencies=[Depends(get_current_user)])
...
# listar periodos
@app.get("/periodos/", response_model=list[PeriodoOut], tags=["periodos"], dependencies=[Depends(get_current_user)])
def read_periodos(db: Session = Depends(get_db)):
    periodos = db.query(Periodo).all()
    return periodos

# obtener periodo por ID
@app.get("/periodos/{periodo_id}", response_model=PeriodoOut, tags=["periodos"], dependencies=[Depends(get_current_user)])
...
# actualizar periodo
@app.put("/periodos/{periodo_id}", response_model=PeriodoOut, tags=["periodos"], dependencies=[Depends(get_current_user)])
...
# eliminar periodo
@app.delete("/periodos/{periodo_id}", tags=["periodos"], dependencies=[Depends(get_current_user)])
...
# crud para aulas
#crear aula
@app.post("/aulas/", response_model=AulaOut, tags=["aulas"], dependencies=[Depends(get_current_user)])
...
# listar aulas
@app.get("/aulas/", response_model=list[AulaOut], tags=["aulas"], dependencies=[Depends(get_current_user)])
def read_aulas(db: Session = Depends(get_db)):
    aulas = db.query(Aula).all()
    return aulas
# obtener aula por ID
@app.get("/aulas/{aula_id}", response_model=AulaOut, tags=["aulas"], dependencies=[Depends(get_current_user)])
def read_aula(aula_id: UUID4, db: Session = Depends(get_db)):
    ...
    return aula
# actualizar aula
@app.put("/aulas/{aula_id}", response_model=AulaOut, tags=["aulas"], dependencies=[Depends(get_current_user)])
def update_aula(aula_id: UUID4, aula: AulaUpdate, db: Session = Depends(get_db)):
    ...
    return db_aula
# eliminar aula
@app.delete("/aulas/{aula_id}", tags=["aulas"], dependencies=[Depends(get_current_user)])
